...
namespace Webapp.Pages
{
    public class EditProductModel : PageModel
    {
        ...
        public EditProductModel(IAdminProductService adminProductService, ICategoryService categoryService)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            var data = await _adminProductService.GetProductByIdAsync(id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var result = await _adminProductService.UpdateProductAsync(Product);
